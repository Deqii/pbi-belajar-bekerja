...
<section class="py-16 bg-white mt-16 mb-2">
    <div class="container mx-auto px-4 max-w-6xl">
        ...
        <div class="text-center mb-12">
            <h2 class="text-4xl text-center leading-tight font-semibold">
                Level Up bareng Komunitas Hebat Kami
            </h2>
            <p class="text-center text-black text-sm mt-3">Gabung, Seru-seruan, dan Temukan Energi Baru untuk Capai Karirmu!</p>
        </div>
        
        <div class="mb-8 max-w-4xl mx-auto mt-6">
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 12px;">
                
                <div style="display: flex; flex-direction: column; gap: 12px;">
                    <div style="height: 200px; border-radius: 8px; width: 100%; overflow: hidden;">
                    ...
                    <div style="background-color: #FFE066; padding: 1rem; border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -2px rgba(0, 0, 0, 0.1); height: 200px; width: 100%;">
                        <h4 class="font-bold text-base mb-1 leading-tight">Lorem Ipsum Dolor Sit</h4>
                        <p class="text-xs leading-relaxed">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer ac nisl vitae pretium vivamus.</p>
                    </div>
                </div>
                
                <div style="height: 416px; border-radius: 8px; width: 100%; overflow: hidden;">
                ...
                <div style="display: flex; flex-direction: column; gap: 12px;">
                    <div style="background-color: #FFF4BF; padding: 1rem; border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -2px rgba(0, 0, 0, 0.1); height: 200px; width: 100%;">
                        <h4 class="font-bold text-base mb-1 leading-tight">Lorem Ipsum Dolor Sit</h4>
                        <p class="text-xs leading-relaxed">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer ac nisl vitae pretium vivamus.</p>
                    </div>
        ...
        <div class="text-center mt-8">
            <p class="text-text1 text-sm mb-1">Ikuti event terdekat dan ukir momen seru bersama komunitas hebat kami</p>
            <a href="#" class="text-security-blue font-semibold hover:opacity-80 inline-flex items-center gap-1 transition-opacity">
...
<!-- CAT -->
<div class="flex mt-16 max-w-4xl gap-8 mx-auto items-stretch">
    <!-- Card Kiri -->
    <section class="w-1/2 text-right shadow-2xl p-8 rounded-xl bg-white flex flex-col justify-between">
        <div>
            <h3 class="text-2xl text-text1 font-semibold leading-tight mb-4">
                Beasiswa Project-Based <br/> Internship
            </h3>
            <div class="inline-block max-w-[85%]">
                <p class="font-medium text-xs text-text1 leading-relaxed">
                    Biaya bukan halangan. Buktikan potensi melalui Capstone of Class PBI dan raih pengalaman kerja nyata bersama kami.
                </p>
            </div>
        </div>
        <div class="mt-6">
            <button class="bg-yellow text-text1 font-semibold w-[237px] h-[50px] rounded-sm p-2 cursor-pointer hover:bg-yellow-hover">
